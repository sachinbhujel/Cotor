    ...
    return (
        <div className="m-auto w-[90%] py-8 flex flex-col gap-12">
            ...
            <div className="flex items-center sm:flex-row flex-col gap-10 justify-center">
                <div className="flex flex-col items-center gap-5 h-max bg-[#ffffff] rounded-md border border-[#093b72] p-2 py-4 hover:scale-102 active:scale-102 transition-transform duration-300 cursor-pointer hover:bg-[#093b72] hover:text-white active:bg-[#093b72] active:text-white">
                ...
                <div className="flex flex-col items-center gap-5 h-max bg-[#ffffff] rounded-md p-2 border border-[#093b72] p-2 py-4 hover:scale-102 active:scale-102 transition-transform duration-300 cursor-pointer hover:bg-[#093b72] hover:text-white active:bg-[#093b72] active:text-white">
                    <div className="w-16 h-16 flex items-center justify-center rounded-md bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
