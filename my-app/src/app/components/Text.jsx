      ...
      {textButtonClick && (
        <div className="flex flex-col gap-6 py-1">
          ...
          <div className="flex gap-6 flex-col">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between">
                <p className="font-semibold text-base text-white">Paragraph</p>
                <div
                  className={`flex items-center text-[#838383] cursor-pointer hover:text-[#bbbbbb] ${
                    paraShowMore ? "text-[#bbbbbb]" : ""
                  }`}
                  onClick={() => setParaShowMore(!paraShowMore)}
                >
                  <p className="text-sm font-semibold">More</p>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <div
                    ...
                    onClick={() => {
                      setTextEditClick(true);
                      setTextEditData("font-bold text-xl lowercase text-white");
                    }}
                  >
                ...
                {paraShowMore && (
                  <div className="grid grid-cols-3 gap-2">
                    <div
                      ...
                      onClick={() => {
                        setTextEditClick(true);
                        setTextEditData("font-bold text-xl lowercase");
                      }}
                    >
                      <h1 className="font-bold text-xl lowercase">Text</h1>
                    </div>
                    <div
                      className="h-18 bg-[#3c3d3f] rounded-sm flex justify-center items-center cursor-pointer"
                      onClick={() => {
